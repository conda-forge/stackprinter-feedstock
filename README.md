...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stackprinter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7005&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stackprinter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stackprinter` can be installed with:

```
conda install stackprinter
```

It is possible to list all of the versions of `stackprinter` available on your platform with:
